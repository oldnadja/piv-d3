...
}), define("underscore-mixins", function() {}), define("config-angular", [ "angular", "config/configuration", "angular-route", "angular-resource", "underscore", "underscore-mixins" ], function(angular, configuration) {
...
define("app/module", [ "angular", "config-angular", "angular-ui-router" ], function(angular, configAngular) {
    ...
    return app.run([ "$rootScope", "$state", "$stateParams", function($rootScope, $state, $stateParams) {
        $rootScope.$state = $state, console.log("$state"), console.log($state), $rootScope.$stateParams = $stateParams;
    } ]), app;
    ...
    return ModulePiv.config([ "$stateProvider", function($stateProvider) {
        console.log("lkjkleryhjklejhklesjr"), console.log($stateProvider), $stateProvider.state("index", {
    ...
    var PivController = function($scope, $http, Vector) {
        console.log(";ewgkjlerjykljeklryjklrjeyklrejklrjewykl"), Vector.$promise.then(function(result) {
            console.log(result);
    ...
    return PivController.$inject = [ "$scope", "$http", "VectorService" ], PivController;
}), define("piv/controllers/graphController", [ "underscore" ], function() {
    "use strict";
    var GraphController = function() {};
    return GraphController.$inject = [ "$scope" ], GraphController;
}), define("module-piv", [ "piv/module", "piv/services/VectorService", "piv/controllers/pivController", "piv/controllers/graphController" ], function(ModulePiv, VectorService, pivController, graphController) {
    ModulePiv.factory("VectorService", VectorService).controller("pivController", pivController).controller("graphController", graphController);
}), define("config-modules", [ "module-app", "module-piv" ], function() {
    return !0;
}), define("main", [ "angular", "config-angular", "config-modules" ], function(angular) {
    return function() {
        "use strict";
        console.log("ldaskfjkjashgjehkjhkjrhew"), angular.bootstrap(document, [ "app" ]);
    };
});