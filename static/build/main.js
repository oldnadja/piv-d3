...
define("config-angular", [ "angular", "angular-route", "angular-resource" ], function(angular, configuration) {
    var standardAngularModules = [ "ngRoute", "ngResource", "piv" ], config = angular.module("config", []);
...
define("app/module", [ "angular", "config-angular", "angular-ui-router" ], function(angular, configAngular) {
...
}.call(this), define("piv/controllers/pivController", [ "underscore" ], function() {
    "use strict";
    ...
    return !0;
}), define("main", [ "angular", "angular-route", "angular-resource", "config-angular", "config-modules" ], function(angular) {
    return function() {
        "use strict";
